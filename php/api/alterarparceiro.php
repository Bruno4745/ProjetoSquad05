...
<body>
    <div class="container col-6">
        <form class="form" method="POST" action="../actions/atualizarparceiro.php?id=<?php echo $row['id_parceiros'] ?>" class="col-md-4 mx-auto">
            ...
            <button class="btn btn-primary mt-3" type="submit" name="botao" value="Alterar">Alterar</button>
