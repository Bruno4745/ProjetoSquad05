...
<body>
    <div class="container-fluid">
        <div class="row">
            <form method="POST" action="../actions/excluirparceiro.php?id=<?php echo $row['id_parceiros'] ?>" class="col-md-4 mx-auto">
                <h4> EXCLUIR </h4>
                ...
                <button type="submit" name="botao" value="Excluir">Excluir</button>
