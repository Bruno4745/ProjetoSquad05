              ...
              <Row className=" justify-content-md-center  ">
                <Col md={7} style={BorderProfs}>
                  <p>
                    ...
                    assumam seu papel no atendimento à gestante, com competência
                    técnica, conhecimento teórico e compromisso ético para
            ...
            <Row className=" justify-content-md-center ">
              <Col md={12}>
                <p>
                  ...
                  Assim, todos os profissionais qualificados ao atendimento dessa
                  demanda devem combater atitudes de criminalização e colaborar
                  para a construção de uma nova cultura, em que a mulher seja
                  vista como sujeito de direitos e sujeito da própria história.
                </p>
              </Col>
            </Row>
          </Col>
              ...
              <Col md={8} style={Row10Profs}>
                ...
                <p>
                 <strong>Para garantir o direito da gestante de ser atendida prontamente
                  ...
                  Adolescente prevê uma multa de R$ 1.000,00 a R$ 3.000,00 para o
                  médico, enfermeiro, dirigente de estabelecimento de saúde,
                  funcionário de programa oficial ou comunitário destinado à
                  garantia do direito à convivência familiar que deixar de,
                  imediatamente, encaminhar à autoridade judiciária caso de que
                  tenha conhecimento, envolvendo mãe ou gestante interessada em
                  entregar seu filho para adoção. (ECA, art. 258-B).</strong> 
                </p>
              </Col>
            </Row>
            </Col>
